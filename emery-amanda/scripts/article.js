...
Article.prototype.toHtml = function() {
  ...
  // REVIEW: If your template will use properties that aren't on the object yet, add them. //no prop to add
...
// because a,b are multiple parameters of a separate function that is nested within the .sort method and articleObject is a single arguement. Both function are legitimate but
rawData.sort((a,b) => {
